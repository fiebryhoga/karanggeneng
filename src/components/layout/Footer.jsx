...
const Footer = () => {
  ...
  return (
    <div className="relative w-full bg-white flex flex-col justify-between min-h-screen xl:min-h-0">
      {/* Background Image */}
      <img
      ...
      {/* Konten Utama */}
      <div className="relative z-10 flex flex-col gap-10 px-4 md:px-12 xl:px-28 py-10 h-full">
        {/* Konten Atas */}
        ...
        <div className="flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="w-full md:w-5/12 flex flex-col gap-4">
            ...
            <p className="text-white text-sm md:text-base font-medium text-justify">
            ...
            <p className="text-white text-sm md:text-base">
              Jl. Raya Karanggeneng No. 1, Karanggeneng, Kabupaten Lamongan,
              Jawa Timur 62254
            </p>
          </div>

          {/* Kolom Kanan */}
          <div className="w-full md:w-7/12 flex flex-col sm:flex-row gap-8 justify-between">
        ...
        <div className="border-t border-white/30 pt-6">
          <p className="text-center text-white text-xs md:text-sm">
            &copy; Copyright {currentYear} | Pemerintahan Desa Karanggeneng |
