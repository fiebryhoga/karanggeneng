...
const Hero = () => {
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center relative bg-gradient-to-t from-black via-black to-blue-900 overflow-hidden">
      ...
      {/* Content */}
      <div className="flex flex-col justify-end md:justify-center items-end md:items-center gap-20 md:gap-0 w-full h-full relative z-10 md:pb-24 sm:px-10 md:px-20">
        {/* Welcome Text */}
